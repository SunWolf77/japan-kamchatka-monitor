  ...
  if (nodeId === "kamchatka") {
    return [
      ...
      },
      {
        ...
        subtitle: "IVS · Kamchatka / Kurils ICAO aviation colour (authority)",
        href: "http://kvert.febras.net/",
        group: "authority",
      },
      {
        id: "kvert-weekly",
        title: "KVERT weekly release",
        subtitle: "Full colour inventory · English",
        href: "http://kvert.febras.net/index?type=3",
        group: "authority",
      },
      {
        id: "usgs-hans",
        title: "USGS HANS volcano alerts",
        subtitle: "U.S. only · AVO Aleutians (not Kamchatka authority)",
        href: "https://www.usgs.gov/programs/VHP/volcano-updates",
        group: "authority",
      },
      {
        id: "avo",
        title: "Alaska Volcano Observatory",
        subtitle: "Aleutian neighbor context for NW Pacific ash",
        href: "https://www.avo.alaska.edu/",
        group: "authority",
      },
      {
        id: "gsras",
