...
import { KvertPanel } from "@/components/feeds/KvertPanel";
import { UsgsVolcanoPanel } from "@/components/feeds/UsgsVolcanoPanel";
          ...
          <div className="map-shell @container/map flex flex-col gap-2">
            ...
            {nodeId === "kamchatka" && (
              <div className="grid gap-2 sm:grid-cols-2">
                <KvertPanel compact />
                <UsgsVolcanoPanel compact avoFirst />
              </div>
            )}
            {!quiet && (
